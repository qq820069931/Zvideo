...
<html>
    <head>
        ...
        <script type="text/javascript" src="<%=basePath%>publicUtil/jquery-3.2.1.min.js"></script>
         <script type="text/javascript" src="<%=basePath%>js/gx/Chart.js" charset="utf-8"></script>
       ...
       <link rel="stylesheet" href="<%=basePath%>css/gx/index.css" type="text/css"></link>
        <link rel="stylesheet" href="<%=basePath%>css/gx/chat.css" type="text/css"></link>
         <link rel="stylesheet" href="<%=basePath%>css/fxz/css.css" type="text/css"></link>
        
         
          </head>
    <body >
               <jsp:include   page="<%=basePath%>/jsp/gx/head.jsp" flush="true"/>
    	<div class="runs" >
    	...
    	<ol>
             ...
             <div style="margin-top: 30px;" class="redeoHead">
                ...
                <span >
                   ${video.vclick}热度&nbsp;&nbsp;&nbsp;评论数:${replyNumber}
             ...
             <div class="video">
      <jsp:include   page="Live.jsp" flush="true"/>
       ...
       <a href="/common/othervideo?uid=${video.vuid}"><img src=" ../img/touxiang.jpg"/></a>
        ...
        -->
    		<li>
    		<div class="chat">
    		<div class="buttonChatDiv"><button  type="button" class="layui-btn layui-btn-primary buttchar" style="width: 172px">聊天室</button>
    		<button type="button" class="layui-btn layui-btn-primary buttman" style="width: 172px">在线人数
		...
		<div class="center-info">
                	...
                	<div class="member"><!-- 在线人数信息打印  头像 名字 --></div>

			
		
	   <span class="uname" style="display:none">${use.unname}</span>	  <!-- 登录欢迎信息  聪session中获取 -->
            ...
            <div class="ensu">
                <textarea class="center-input"></textarea>        <!--发送按钮 -->
                <div class="ensure">
                    <button>发送</button>
                </div>
            </div>
